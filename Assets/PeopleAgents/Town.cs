...
public class PersonTown //: Settlement
{
    ...
    public static void death(){
        ...
        */
        ...
        //OOP Method:
        //Now that have all living Agents, randomly select one to die, very un-nuanced for now
    ...
    public static void birth(){
        ...
        */
        ...
        //Maximum Attempts a birth event will be attempted, should lend itself to being more sparce/random.  The value of 5 is arbitrary.
